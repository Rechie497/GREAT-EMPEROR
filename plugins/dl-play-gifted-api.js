...
function _0x374d() {
    const _0x21ae4c = [
        ...
        'body',
        'includes',
        'Error\x20from\x20𝙰𝚁𝙻𝙾𝙳𝚁𝙰𝙶𝙾𝙽\x20𝚂𝙴𝚁𝚅𝙴𝚁:',
        'reply',
        'error',
        'test',
        '\x0a\x0a╭────────────────◆\x0a│\x20*©𝟐𝟎𝟐𝟒\x20𝔄𝔪𝔯𝔶\x20𝔡𝔫\x20𝔡𝔫*\x0a╰─────────────────◆',
        'timestamp',
        '44ztQpdd',
        '6936181mPzHHs',
        'thumbnail',
        ...
        'success',
        '*𝙰𝙼𝚁𝚈\x20𝚂𝙾𝙽𝙶\x20𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁*\x0a\x0a╭───────────────◆\x0a│⿻\x20*Title:*\x20',
        'result',
        'match',
        'download_url',
        'length',
